  ...
  return (
    ...
    >
      ...
      <View style={styles.infoBackground}>
        <Text style={styles.title}>About Eureka Net Zero</Text>
        <Text style={styles.content}>
          This app (Eureka Net Zero) is built using React Native, showcasing the
        ...
        <Text style={styles.content}>
          ...
          systems. The integrated dashboards are authenticated Tableau Embedded
          dashboards, which can show different content based on the user's
          profile.
        </Text>
